      ...
      <div class="container">
        ...
        <div class="navbar-left">
          ...
          <a class="navbar-brand" href="<?php echo e(route('welcome')); ?>">
            <img class="logo-dark" src="<?php echo e(asset('img/myLogoBlack.png')); ?>" alt="logo">
            <img class="logo-light" src="<?php echo e(asset('img/myLogoWhite.png')); ?>" alt="logo">
          </a>
        </div>
        ...
        <a class="btn btn-xs btn-round btn-success" href="<?php echo e(route('login')); ?>">Log In</a>
      ...
      <div class="container">
        <div class="row gap-y align-items-center">
          ...
          <div class="col-6 col-lg-3">
            <a href="/"><img src="<?php echo e(asset('img/myLogoBlack.png')); ?>" alt="logo"></a>
          </div>
...
<?php /**PATH C:\xampp\htdocs\myportfolio\resources\views/layouts/blog.blade.php ENDPATH**/ ?>